...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-primary to-rose-500 text-primary-foreground shadow-lg shadow-primary/30 hover:brightness-105 hover:shadow-xl hover:shadow-primary/35",
        outline:
          "border border-primary/25 bg-white/80 text-foreground shadow-sm backdrop-blur-sm hover:border-primary/45 hover:bg-primary/5 hover:shadow-md hover:shadow-primary/10",
